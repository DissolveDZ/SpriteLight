 ...
 * \sa SDL_GetRenderer
 */
extern DECLSPEC int SDLCALL SDL_GetCurrentRenderOutputSize(SDL_Renderer * renderer,
                                                      int *w, int *h);
 ...
 */
extern DECLSPEC int SDLCALL SDL_SetRenderLogicalPresentation(SDL_Renderer * renderer, int w, int h);
 ...
 * size set by SDL_SetRenderLogicalPresentation(). Otherwise it returns the logical
 * width and height.
 *
 ...
 */
extern DECLSPEC void SDLCALL SDL_GetRenderLogicalPresentation(SDL_Renderer * renderer, int *w, int *h);
 ...
 * \sa SDL_SetRenderLogicalPresentation
 */
extern DECLSPEC void SDLCALL SDL_RenderCoordinatesFromWindow(SDL_Renderer * renderer, 
 ...
 * \sa SDL_SetRenderLogicalPresentation
 */
extern DECLSPEC void SDLCALL SDL_RenderCoordinatesToWindow(SDL_Renderer * renderer, 
                                                            float logicalX, float logicalY,
                                                            int *windowX, int *windowY);
