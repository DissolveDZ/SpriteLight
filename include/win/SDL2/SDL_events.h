...
typedef enum
{
    ...
    SDL_EVENT_SYSWM,             /**< System specific event */
    ...
    SDL_EVENT_GAMEPAD_AXIS_MOTION  = 0x650, /**< Game controller axis motion */
    SDL_EVENT_GAMEPAD_BUTTON_DOWN,          /**< Game controller button pressed */
    SDL_EVENT_GAMEPAD_BUTTON_UP,            /**< Game controller button released */
    SDL_EVENT_GAMEPAD_ADDED,         /**< A new Game controller has been inserted into the system */
    SDL_EVENT_GAMEPAD_REMOVED,       /**< An opened Game controller has been removed */
    SDL_EVENT_GAMEPAD_REMAPPED,      /**< The controller mapping was updated */
    SDL_EVENT_GAMEPAD_TOUCHPAD_DOWN,        /**< Game controller touchpad was touched */
    SDL_EVENT_GAMEPAD_TOUCHPAD_MOTION,      /**< Game controller touchpad finger was moved */
    SDL_EVENT_GAMEPAD_TOUCHPAD_UP,          /**< Game controller touchpad finger was lifted */
    SDL_EVENT_GAMEPAD_SENSOR_UPDATE,        /**< Game controller sensor was updated */
...
typedef struct SDL_GamepadAxisEvent
{
    ...
    Uint32 timestamp;   /**< In milliseconds, populated using SDL_GetTicks() */
    SDL_JoystickID which; /**< The joystick instance id */
    Uint8 axis;         /**< The controller axis (SDL_GamepadAxis) */
    Uint8 padding1;
    Uint8 padding2;
    Uint8 padding3;
    Sint16 value;       /**< The axis value (range: -32768 to 32767) */
...
typedef struct SDL_GamepadButtonEvent
{
    ...
    Uint32 timestamp;   /**< In milliseconds, populated using SDL_GetTicks() */
    SDL_JoystickID which; /**< The joystick instance id */
    Uint8 button;       /**< The controller button (SDL_GamepadButton) */
    Uint8 state;        /**< ::SDL_PRESSED or ::SDL_RELEASED */
    Uint8 padding1;
    Uint8 padding2;
...
typedef union SDL_Event
{
    ...
    SDL_GamepadButtonEvent cbutton;      /**< Game Controller button event data */
    SDL_GamepadDeviceEvent cdevice;      /**< Game Controller device event data */
    SDL_GamepadTouchpadEvent ctouchpad;  /**< Game Controller touchpad event data */
    SDL_GamepadSensorEvent csensor;      /**< Game Controller sensor event data */
